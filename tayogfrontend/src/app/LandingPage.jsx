...
<div className="hero-disciplines-container gap-2 flex justify-center align-middle flex-wrap">
    ...
    <div key={index} className="hero-disciplines hover:border-blue w-52 h-16 px-2 py-1 border border-black border-opacity-20 justify-center items-center gap-4 inline-flex cursor-default text-center shadow-md rounded-lg bg-white">
        {subject}
    </div>
))}
 </div>
...
<div className="top-institutes-posting-container flex justify-center content-center items-center gap-3 flex-col">
  <h2 className='text-3xl font-bold text-blue'>TOP INSTITUTES POSTING</h2>
  <div className="flex flex-row flex-wrap justify-center gap-8">
    {institutionsLogos.map((institution, index) => (
      <div className="w-52 flex justify-center h-16 px-2 py-1 shadow-md rounded-lg bg-white" key={index}>
        <div className="flex-row flex justify-evenly w-full align-middle items-center">
          <Image className="inst-logo" src={institution.logo} alt="Institution Logo" width={40} height={40} />
  ...
  <div className="pre-footer flex w-full h-16 bg-blue justify-between px-8 p-5 items-center max-md:flex-col max-md:h-full max-md:gap-5">
    ...
    <div className="buttons max-md:flex flex-wrap gap-5 justify-center">
      <button  className='py-2 px-8 mx-4 border-2 text-white border-yellowgold rounded-lg  font-semibold'>Post a Job</button>
      <button className='py-2 px-8 mx-4 border-2 bg-yellowgold rounded-lg font-semibold'>Sign IN</button>
    </div>
  </div>
